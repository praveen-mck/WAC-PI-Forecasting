...
select * from uspd_analytics_den.analytics_gold.WAC_PI_FORECAST_BASELINE_PRICE_V2_FINAL_MODIFIED_0603
...
WITH base AS (
    SELECT
        ...
        COUNT(*) AS row_cnt
    FROM uspd_analytics_den.analytics_gold.WAC_PI_FORECAST_BASELINE_PRICE_V2_FINAL_MODIFIED_0603
...
LEFT JOIN vstx v
    ON TRY_TO_NUMBER(u.mtrl_num, NULL) = v.EM_ITEM_NUM
