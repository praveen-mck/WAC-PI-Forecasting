...
base AS (
    SELECT
        ...
        /* =====================================================
           QA helper raw fields
           ===================================================== */
        t_copa.BILL_TYPE_CD AS RAW_BILL_TYPE_CD,
        t_copa.FPA_CUST_SEG_CD AS RAW_FPA_CUST_SEG_CD,
        RIGHT(CAST(t_copa.SAP_CUST_NUM AS STRING), 6) AS SAP_CUST_NUM_6,
        CAST(cust_mstr.CUST_ACCT_ID AS STRING) AS CUST_ACCT_ID,
    ...
    WHERE
        t_copa.POST_DT BETWEEN '2022-01-01' AND '2036-05-31'
