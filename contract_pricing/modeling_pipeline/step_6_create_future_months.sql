...
CREATE OR REPLACE TABLE uspd_analytics_den.analytics_gold.contract_price_future_months_v9 AS
WITH base AS (
    SELECT
        HYBRID_MODEL_KEY_3T,
        mtrl_num,
        anchor_month
    FROM uspd_analytics_den.analytics_gold.contract_price_material_assumptions_v9
),
...
-- - forecast_start_contract_price is the v9 price anchor:
