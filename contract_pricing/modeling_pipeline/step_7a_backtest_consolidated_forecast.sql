...
-- =========================================================
-- STEP 8: FORECAST OUTPUT FORMATTED v1
...
-- SELECT
    ...
    --one time override for timestamp 2026-06-29T19:05:46.782+00:00
    ...
    DATE_FORMAT(f.jump_off_dt, 'yyyy-MM')               AS FCST_ORIGIN_YEAR_MONTH,
    f.forecast_year_num                                 AS FORECAST_YEAR_NUM,
    f.forecast_cal_year_month                           AS FORECAST_CAL_YEAR_MONTH,
    f.forecast_fiscal_year_month                        AS FORECAST_FISCAL_YEAR_MONTH,
    ...
    -- f.material_trend_source                             AS MATERIAL_TREND_SOURCE,
    -- f.expected_monthly_trend_pct                        AS EXPECTED_MONTHLY_TREND_PCT,
    ...
    -- f.forecasted_net_cos                                AS FORECASTED_NET_COS,
