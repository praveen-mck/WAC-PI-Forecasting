...
CONCAT(
    ...
    -- COALESCE(la.wac_significant_decrease_flag, 0)           AS WAC_SIGNIFICANT_DECREASE_FLAG,
    -- COALESCE(la.contract_price_drop_30pct_flag, 0)          AS CONTRACT_PRICE_DROP_30PCT_FLAG,
    -- COALESCE(la.contract_price_inc_30pct_flag, 0)           AS CONTRACT_PRICE_INC_30PCT_FLAG,
